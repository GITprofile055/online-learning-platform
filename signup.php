...
if(isset($_POST["submit"])){
    ...
    $duplicate = mysqli_query($conn, "SELECT *  FROM reg WHERE username = '$username' Or email = '$email'");
    if(mysqli_num_rows($duplicate) > 0){
     ...
     alert('Username or email Has Already Taken');
        ...
        if($password == $cpassword){
            $query = "INSERT INTO reg(name, username, email, password, cpassword) VALUES ('$name','$username','$email','$password','$cpassword')";
...
<body>
    ...
    <form class="" action="" method="post" autocomplete="off">
        ...
        <input type="password"name="cpassword" id="cpassword" required/><br /><br><br><br>
    ...
    <nav class="me">
        ...
        <h1>Planet<span style="color: rgb(156, 32, 214); font-size:large; font-weigth:340px;   
    font-size: 1.0em;">Spark</span></h1><br>
            <div class="wtn"><a href="Admin.php">HOME</a></div>
            <p> "<span style="color: rgb(156, 32, 214); font-size: 70px; font-weigth:840px;   
